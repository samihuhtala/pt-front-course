...
class AddTraining extends Component {
    state = {
        open: false, date: '', duration: '', activity: '', customer: this.props.customer._original.links[0].href
    };
    handleClickOpen = () => {
    ...
    render() {
        ...
        <Dialog
          ...
          <TextField autoFocus margin="dense" name="activity" value={this.state.activity} onChange={this.handleChange} label="Activity" fullWidth/>
            <TextField margin="dense" name="date" value={this.state.date} onChange={this.handleChange} label="Date" fullWidth/>
